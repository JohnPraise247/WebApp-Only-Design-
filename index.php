     ...
     <div id="card" class="card bg-1 mx-5">
      ...
      <div class="card-body">
        ...
        <div class="mt-5 px-4">
         ...
         <a href="main.php" class="btn btn-danger w-100">Sign In</a>
        </div>
      </form>
...
<!--            <img src="images/menu.png" alt=""/>-->
        ...
        <div class="mt-5 px-4">
         ...
         <div class="card-footer text-center">
          ...
          <a href= "create.php"id="cnat" class="text-white-50" style="cursor:pointer;">Create New Account <span style="margin-top: 3px;" class="genericon genericon-next"></span></a>
         </div>
     </div>
  </div>
