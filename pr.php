...
<html>
<head>
<title>OneView WebApp :. Print Reports</title>
  ...
  <div class="container-fluid mb-3">
     <div id="card" class="card bg-1 mx-5">
      <div class="card-header ">
          <h1 class="text-white-50" style="font-size: 25px;">OneView <small class="secondary text-white-50">-  Print Reports</small></h1></div>
      <div class="card-body">
        <div id="pt1">
        ...
        <div class="d-flex">
           ...
           <p class="lead text-white-50" style="font-size: 16px;"><b>Search Results</b></p>
